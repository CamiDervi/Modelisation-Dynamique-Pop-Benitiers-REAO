...
dates_ech
index_c <- c(1,12,20,25,26,28,31,38,40,41,43,45,46,47,48)   # Indice dans le vecteur time des campagnes
...
names(all.sims) <- paste("sf_",TAB$sf,"_b_", TAB$b, "_e_",TAB$e, "_d_",TAB$d,"_Peche_chair_",TAB$Peche_chair,"_Peche_viv_",TAB$Peche_viv,"_T_capture_",TAB$T_capture,"_SIMU_",TAB$SIMU,sep="")[1:nrow(TAB)]
scenarios <- unique(paste("sf_",TAB$sf,"_b_", TAB$b, "_e_",TAB$e, "_d_",TAB$d,"_Peche_chair_",TAB$Peche_chair,"_Peche_viv_",TAB$Peche_viv,"_T_capture_",TAB$T_capture,sep="")[1:nrow(TAB)])
...
save.image(paste0(output,"/ENVIRONNEMENTS/Last_Enviro_04-07_v2.RData"))
